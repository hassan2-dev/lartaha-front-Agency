        ...
        {!allDone && (
          ...
          >
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
              ...
              <Typography variant="h6" sx={{ fontWeight: 700, color: 'info.main', fontSize: '1.5rem' }}>
                {overallProgress}%
              </Typography>
            </Box>
            <LinearProgress
            ...
            return (
              <Box
                ...
                sx={{
                  ...
                  background: isPaused
                    ? isDark ? 'rgba(255,152,0,0.06)' : 'rgba(255,152,0,0.04)'
                    : 'transparent',
                  ...
                  <Box sx={{ flex: 1, minWidth: 0 }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, flexWrap: 'wrap' }}>
                      ...
                      <Typography
                        ...
                        sx={{
                          fontWeight: 600,
                          color: isPaused ? 'warning.main' : isDecrypting ? 'secondary.main' : 'info.main',
                        }}
                      >
                        {isPaused
                          ? 'متوقف'
                      ...
                      <Tooltip title={isPaused ? 'استئناف' : 'إيقاف مؤقت'}>
                        <IconButton
                          ...
                          sx={{
                            ...
                            backgroundColor: isPaused ? 'rgba(76,175,80,0.12)' : 'rgba(255,152,0,0.12)',
                            '&:hover': {
                              backgroundColor: isPaused ? 'rgba(76,175,80,0.22)' : 'rgba(255,152,0,0.22)',
                            },
                          }}
                        >
                          {isPaused ? (
